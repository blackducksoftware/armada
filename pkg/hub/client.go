...
// ListAllPolicyRules pulls in all policy rules in a single API call
func (hub *Client) ListAllPolicyRules() (*hubapi.PolicyRuleList, error) {
	var list *hubapi.PolicyRuleList
	var fetchError error
	err := hub.circuitBreaker.IssueRequest("allPolicyRules", func() error {
		limit := 2000000
		list, fetchError = hub.client.ListPolicyRules(&hubapi.GetListOptions{Limit: &limit})
		if fetchError != nil {
			log.Errorf("fetch error: %s", fetchError.Error())
		}
		return fetchError
...
// ListAllUsers pulls in all users in a single API call
func (hub *Client) ListAllUsers() (*hubapi.UserList, error) {
	var list *hubapi.UserList
	var fetchError error
	err := hub.circuitBreaker.IssueRequest("allUsers", func() error {
		limit := 2000000
		list, fetchError = hub.client.ListUsers(&hubapi.GetListOptions{Limit: &limit})
		if fetchError != nil {
			log.Errorf("fetch error: %s", fetchError.Error())
		}
		return fetchError
...
// ListAllComponents pulls in all components in a single API call
func (hub *Client) ListAllComponents() (*hubapi.ComponentList, error) {
	var list *hubapi.ComponentList
	var fetchError error
	err := hub.circuitBreaker.IssueRequest("allComponents", func() error {
		limit := 2000000
		list, fetchError = hub.client.ListComponents(&hubapi.GetListOptions{Limit: &limit})
		if fetchError != nil {
			log.Errorf("fetch error: %s", fetchError.Error())
		}
		return fetchError
...
// GetCodeLocation will retrieve a given code location from the hub
func (hub *Client) GetCodeLocation(link hubapi.ResourceLink) (*hubapi.CodeLocation, error) {
	var cl *hubapi.CodeLocation
	var fetchError error
	err := hub.circuitBreaker.IssueRequest("codeLocation", func() error {
		cl, fetchError = hub.client.GetCodeLocation(link)
		return fetchError
	})
	if err != nil {
		return nil, err
	}
	return cl, fetchError
}
...
// GetProject will retrieve a given project from the hub
...
// GetPolicyRule will retrieve a given policy rule from the hub
...
// GetComponent will retrieve a given component from the hub
